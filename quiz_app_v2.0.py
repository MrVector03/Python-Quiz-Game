...
def create_account():  # creates account and puts it into the database
    ...
    cursor.execute("INSERT INTO Accounts (username, password, rightAns, wrongAns, accuracy, cpl_q, score) VALUES (%s, %s, %s, %s, %s, %s, %s)", (username, password, 0, 0, 0.0, 0, 0))
    db.commit()
...
def quiz_display():
    while True:
        ...
        temporary_list = [i for i in cursor]
        if username == temporary_list[0][1]:
            break
        else:
            print("There was an error finding your account, please try again.")
            print("If you don't have one, create an account.")
...
while True:
    ...
    print("- Display account info ('display_account', 'display account')")
    print("- Create a quiz ('create_quiz', 'create quiz')")
    print("- Display quiz info ('display_quiz', 'display quiz')")
    print("- Create questions for the quiz ('create_questions', 'create questions')")
    print("- Display questions for the quiz ('display_questions', 'display questions')")
    print("- Create answers for the quiz ('create_answers', 'create answers')")
